...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="card card-primary">
                    ...
                    <?php
        $articleId= $_GET['id'];
        $result = $conn->query("SELECT * FROM `articles` WHERE id = $articleId ")->fetch_assoc();
        ?>
                    <form role="form" action="update.php" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" value="<?=$result['id']?>" id="id" name="id">

                                <input type="text" class="form-control" value="<?=$result['subject']?>" id="subject"
                                    name="subject" placeholder="Subject">
                            </div>

                            <div class="form-group">
                                <label for="sub_title">Sub title</label>
                                <input type="text" class="form-control" id="sub_title" value="<?=$result['sub_title']?>"
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <textarea id="detail" name="detail"
                                            style="width: 100%"><?=$result['detail']?></textarea>
                                    </div>
                                </div>
                            </div>
    ...
    $(document).ready(function() {
        let imageName = "<?php Print($result['image']); ?>";
        if (imageName) {
            $('.figure').addClass('d-block')
            let imageSrc = "../../../blog/images/" + imageName;
